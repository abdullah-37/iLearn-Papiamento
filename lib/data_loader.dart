...
//   ) async {
//     final sourceField = _localeField[locale] ?? _localeField['en']!;
//     final path = 'assets/data/$locale/$moduleKey.json';
//     final raw = await rootBundle.loadString(path);
//     final list =
//         (json.decode(raw) as List<dynamic>).cast<Map<String, dynamic>>();

//     return list
//         .where((m) => m.containsKey(sourceField) && m.containsKey('papiamento'))
//         .map((m) => Phrase.fromJson(m, sourceField))
//         .toList();
//   }

//   static Future<String> loadSubcategory(String moduleKey, String locale) async {
//     final assetPath = 'assets/data/$locale/$moduleKey.json';
//     final raw = await rootBundle.loadString(assetPath);
//     final List<dynamic> list = json.decode(raw);

//     // Find the first map that has a 'subcategory' key.
//     final Map<String, dynamic> subMap = list
...
//     final String? sub = subMap['subcategory'] as String?;
//     return sub ?? moduleKey;
//   }
// }
